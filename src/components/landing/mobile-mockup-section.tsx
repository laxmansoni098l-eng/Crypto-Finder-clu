...
const MobileMockup = ({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto bg-neutral-900 border-neutral-700 border-[10px] rounded-[2.5rem] h-[320px] w-[160px] shadow-2xl shadow-primary/20 cursor-pointer",
        className
      )}
      style={style}
      onClick={onClick}
    >
      <div className="absolute top-4 left-1/2 -translate-x-1/2 w-20 h-4 bg-neutral-900 rounded-full z-20"></div>
